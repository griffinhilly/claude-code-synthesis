...
| `council` | — | Advisors (5 distinct personas) | **Anonymous peer review** | Chairman synthesizes | 5-5-1 | 1 |
...
| `--council` | Shorthand for `--mode council` (5 personas + anonymous peer review) | — |
...
/dialectic-review --ideate features for the analytics database   # Ideation, 5-2-3
...
- **Default model: the strongest available model (e.g. Opus) for ALL roles** (advocates, counter-advocates, referees, synthesizers, pessimists, optimists, risk-assessors, hostile auditor). Judgment is load-bearing on every role in this skill, not just synthesis. Override only if the user explicitly requests a cheaper model for a specific run.
...
- [Riley-Coyote/polyclaude](https://github.com/Riley-Coyote/polyclaude) -- temporal and user-advocate perspective lenses, and council-mode inspiration (5-persona anonymous peer review)
