...
After each subagent returns, validate the report. See `~/.claude/skills/implement/subagent-validation.md` for the full protocol.
...
See `~/.claude/skills/implement/rules.md` for implementation guardrails.
